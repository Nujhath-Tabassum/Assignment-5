                         ...
                         <h2 className="text-lg font-semibold text-gray-900"> Your Stack</h2>
                            ...
                            <p className="text-xs text-gray-400 mt-1">
                                {stack.length === 0
                                    ...
                                    : `${stack.length} Technology Selected${stack.length > 1 ? "s" : ""}`
                                }
                            </p>
                            ...
                            {stack.length === 0 ? (
                                ...
                                <div className="mt-4 space-y-2">
                                    ...
                                    {stack.map((technology) => (
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                className="ml-auto text-xl font-light text-gray-400 hover:text-gray-600"
                                            >
                                                ×
                                            </button>
                                    ...
                                    <button
                                        onClick={() => setStack([])}
                                        className="w-full mt-10 h-8 border border-red-300 rounded-lg text-sm font-medium text-red-500 hover:bg-red-50 transition"
                                    >
                                        Remove All
                                    </button>
